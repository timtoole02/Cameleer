...
export const RuntimePage: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', height: '100%', overflowY: 'auto' }}>
      ...
      <div style={{ backgroundColor: 'white', padding: '1rem', borderRadius: '4px' }}>
        <h4>Agent Runs</h4>
        {runs.length === 0 ? <EmptyState title="No Runs" description="No agents are currently running." /> : (
...
export const SettingsPage: React.FC = () => {
  return <div><h3>Settings</h3><p>Settings configuration coming soon.</p></div>;
};

export const MemoryPage: React.FC = () => {
  return <div><h3>Memory</h3><p>Memory search and contextual retrieval UI coming soon.</p></div>;
};
