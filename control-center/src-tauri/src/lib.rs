...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            task_manager::assign_task_to_agent,
            task_manager::block_task,
            task_manager::unblock_task,
            task_manager::reopen_task,
            task_manager::cancel_task,
            task_manager::delete_task,
            task_manager::start_agent_task_run,
            task_manager::get_task_run_status,
            task_manager::list_task_runs,
            task_manager::save_task_progress_update,
            task_manager::list_task_progress_updates,
            task_manager::list_task_activity,
            task_manager::record_task_activity,
            task_manager::generate_task_work_receipt,
            task_manager::get_task_work_receipt,
            task_manager::approve_work_receipt,
            task_manager::complete_task,
            task_manager::send_task_back_to_agent,
            ...
            board_services::list_board_columns,
            board_services::create_board_column,
            board_services::update_board_column,
            board_services::move_board_column,
            board_services::set_column_wip_limit,
